  ...
  public:
    ...
    void recalculateState()
    {
        return this->publishState(
          this->fingers_.index->getValue() > this->threshold_ && this->fingers_.middle->getValue() > this->threshold_
          && this->fingers_.ring->getValue() > this->threshold_ && this->fingers_.pinky->getValue() > this->threshold_
        );
    }
